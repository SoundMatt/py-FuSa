...
_OBJECTIVES = [
    ...
    (
        ...
        "A-1",
        "§4/§11.1",
        "Software Planning Process: Software Development Plan",
    ...
    (
        ...
        "A-1",
        "§4/§11.2",
        "Software Development Standards defined",
        ["DAL-A", "DAL-B", "DAL-C", "DAL-D"],
        "CONTRIBUTING.md",
    ),
    (
        ...
        "A-2",
        "§5.1",
        "Software requirements defined (HLR)",
        ["DAL-A", "DAL-B", "DAL-C", "DAL-D"],
        ".fusa-reqs.json",
    ),
    (
        ...
        "A-2",
        "§5.2",
        "Software HLR comply with system requirements",
        ["DAL-A", "DAL-B", "DAL-C"],
        ".fusa-reqs.json",
    ),
    (
    ...
    (
        ...
        "A-3",
        "§11.9",
        "Software Design Description (LLR/architecture)",
        ["DAL-A", "DAL-B", "DAL-C"],
        "boundary.json",
    ),
    (
        ...
        "A-3",
        "§6.3",
        "Data/control coupling documented",
        ["DAL-A", "DAL-B", "DAL-C"],
    ...
    (
        ...
        "A-4",
        "§11.11",
        "Source code complies with software design",
        ["DAL-A", "DAL-B", "DAL-C", "DAL-D"],
        "check-report.json",
    ),
    (
        ...
        "A-4",
        "§11.11",
        "Source code complies with software standards",
        ["DAL-A", "DAL-B", "DAL-C", "DAL-D"],
        "check-report.json",
    ),
    (
        ...
        "A-5",
        "§6.3.3",
        "Integration process: no unintended coupling",
        ["DAL-A", "DAL-B", "DAL-C"],
        "coupling-report.json",
    ),
    (
        ...
        "A-6",
        "§6.4",
        "Verification: HLR-based test cases exist",
        ["DAL-A", "DAL-B", "DAL-C", "DAL-D"],
        "qualify-report.json",
    ),
    (
        ...
        "A-6",
        "§6.4.2",
        "Verification: LLR-based test cases exist",
        ["DAL-A", "DAL-B", "DAL-C"],
        "qualify-report.json",
    ),
    (
        ...
        "A-6",
        "§6.4.3",
        "Structural coverage: statement coverage (DAL-C)",
        ["DAL-A", "DAL-B", "DAL-C"],
    ...
    (
        ...
        "A-6",
        "§6.4.4",
        "Structural coverage: branch/decision coverage (DAL-B)",
        ["DAL-A", "DAL-B"],
        "coverage-report.json",
    ),
    (
        ...
        "A-6",
        "§6.4.4.3",
        "Structural coverage: MC/DC (DAL-A)",
        ["DAL-A"],
        "coverage-report.json",
    ),
    (
        ...
        "A-7",
        "§7.2",
        "Configuration management: all life cycle data under CM",
        ["DAL-A", "DAL-B", "DAL-C", "DAL-D"],
        ".gitignore",
    ),
    (
    ...
    (
        ...
        "A-8",
        "§8.1",
        "Software Quality Assurance: reviews conducted",
        ["DAL-A", "DAL-B", "DAL-C"],
        "qualify-report.json",
    ),
    (
        ...
        "A-9",
        "§9.1",
        "Certification Liaison: PSAC prepared",
        ["DAL-A", "DAL-B", "DAL-C", "DAL-D"],
        "sas.json",
    ),
    (
    ...
    (
        ...
        "A-10",
        "§11.4",
        "SBOM / software component list present",
        ["DAL-A", "DAL-B", "DAL-C", "DAL-D"],
        "sbom.json",
    ),
]
...
def _status(
    project_root: str, evidence_file: str, dal: str, dals_apply: List[str]
) -> tuple:
...
def render_text(doc: dict) -> str:
    ...
    for obj in doc["objectives"]:
        ...
        lines.append(
            f"  {marker} {obj['id']:8s} {obj['status']:10s} {obj.get('title', '')}"
        )
