...
_OBJECTIVES = [
    ...
    ("26262-6-1",  "6.4.1",  "Software requirements specification",         "QM",    ".fusa-reqs.json"),
    ("26262-6-2",  "6.4.2",  "Software safety requirements allocation",     "ASIL-A",".fusa-reqs.json"),
    ("26262-6-3",  "6.4.3",  "Software architectural design",               "QM",    "boundary.json"),
    ("26262-6-4",  "6.4.3",  "Data and control coupling analysis",          "ASIL-B","coupling-report.json"),
    ("26262-6-5",  "6.4.4",  "Software unit design",                        "QM",    "check-report.json"),
    ("26262-6-6",  "6.4.4",  "Formal notation for ASIL-D unit design",      "ASIL-D","check-report.json"),
    ("26262-6-7",  "6.4.5",  "Software unit verification",                  "QM",    "qualify-report.json"),
    ("26262-6-8",  "6.4.5",  "Structural coverage ≥ statement (ASIL-A)",    "ASIL-A","coverage-report.json"),
    ("26262-6-9",  "6.4.5",  "Structural coverage: branch/decision (ASIL-B)","ASIL-B","coverage-report.json"),
    ("26262-6-10", "6.4.5",  "Structural coverage: MC/DC (ASIL-D)",         "ASIL-D","coverage-report.json"),
    ("26262-6-11", "6.4.6",  "Software integration testing",                "QM",    "qualify-report.json"),
    ("26262-6-12", "6.4.7",  "Verification of software architectural design","ASIL-A","boundary.json"),
    ...
    ("26262-6-17", "6.4.13", "Problem reports / change management",         "QM",    ".fusa-problems.json"),
    ...
    ("26262-6-20", "6.4.15", "Software release (provenance/SBOM)",          "ASIL-A","provenance.json"),
]

_ASIL_RANK = {"QM": 0, "ASIL-A": 1, "ASIL-B": 2, "ASIL-C": 3, "ASIL-D": 4}


def _status(project_root: str, evidence_file: str, asil_min: str, project_asil: str) -> tuple:
