...
_TEMPLATES = {
    "safety-plan": {
        ...
        "content": lambda module, standard: f"""# Software Development Plan — {module}
...
""",
    ...
    "hara": {
        ...
        "content": lambda module, standard: json.dumps({
            "project": module,
            "standard": standard,
            ...
            "hazards": [
                {
                    ...
                    "source": "",
                    "situations": ["OS-001"],
                    "risk": {"severity": "S2", "exposure": "E3", "controllability": "C2", "asil": "ASIL-C"},
                    "safetyGoals": ["SG-001"],
                }
            ],
            "safetyGoals": [
...
def generate(name: str, project_root: str, cfg: Config, force: bool = False) -> str:
    ...
    if os.path.exists(out_path) and not force:
        raise FileExistsError(f"{tmpl['filename']} already exists; use --force to overwrite")
